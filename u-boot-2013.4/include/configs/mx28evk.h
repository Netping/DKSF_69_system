...
#define CONFIG_MACH_TYPE	3613 /* MACH_TYPE_MX28EVK */
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"netboot=echo Booting from net ...; " \
		...
		"load_next_kernel=if itest.w *800560A0 == 00000000; then run load_kernel0; else run load_kernel1; fi;\0" \
		"load_kernel0=echo Loading kernel0...; mw.l 0x800560A0 0x00000001; nboot 0x42000000 0 0x00be0000;\0" \
		"load_kernel1=echo Loading kernel1...; mw.l 0x800560A0 0x00000000; nboot 0x42000000 0 0x00fa0000;\0"
